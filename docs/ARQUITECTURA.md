...
### 2.5 Lo que se veía sano y no lo estaba
...
### Fase 0 — El experimento que decide (2-3 días) · *antes de elegir*
...
1. **¿A, B o C?** (mi voto: **C**, con la Fase 0 primero — si el experimento
   falla, cae sola en B sin haber perdido nada).
