...
export const enUS: Record<TranslationKey, string> = {
  ...
  "bandeja.paraResponder": "Needs reply",
  ...
  "case.paraResponder.banner": "A message arrived after the agent finished. A person answers it.",
  "case.paraResponder.marcar": "Mark as answered",
  "case.paraResponder.hecho": "Marked as answered.",
  "case.paraResponder.cambio": "The case changed while you were viewing it. Check it again.",
  ...
  "audit.case.marked_answered": "Marked as answered",
  "audit.claim.message_not_read": "Message the agent did not read",
  ...
  "aiProvider.modelo": "Gemini model",
  ...
  "consola.pestanas": "Agent console sections",
