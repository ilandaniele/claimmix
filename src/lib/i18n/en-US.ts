...
export const enUS: Record<TranslationKey, string> = {
  ...
  "field.hay_heridos": "Injuries",
  "field.hora_siniestro": "Time of the incident",
  "field.provincia_siniestro": "Province",
  "field.patente_vehiculo": "Vehicle plate",

  // ── Doc status labels ──────────────────────────────────────────────────────
  "doc.status.pending": "Missing",
  ...
  "audit.email.received": "Message received",
  "audit.intake.agent_decision": "Agent decision",
  "audit.attachment.rejected": "Attachment rejected",
  "audit.claim.missing_info_requested": "Missing data requested",
  "audit.claim.confirmation_requested": "Confirmation requested",
  "audit.claim.documents_received": "Documents received",
  "audit.claim.documents_declined": "Claimant said a document is not available",
  "audit.claim.specialist_required": "Sent to a specialist",
  "audit.claim.specialist_alerted": "Specialist notified",
  "audit.claim.case_reopened": "Reopened by a new message",
  "audit.claim.closed_abandoned": "Closed: the claimant did not reply",
  "audit.claim.field_confirmed": "Value confirmed",
  "audit.claim.field_rejected": "Value discarded",
  "audit.case.assigned": "Assigned to an analyst",
  "audit.case.human_reply": "A team member replied",
  "audit.case.re_analyze_triggered": "Re-analysis requested",
  "audit.agent.deliberated": "The agent chose the next step",
  "audit.agent.note": "The agent left a note",
  "audit.agent.deliberation_failed": "The agent could not decide and followed the fixed rule",
  "audit.attachment.rehosted": "Attachment stored",
  "audit.email.outbound_sent": "Message sent to the claimant",
  "audit.email.outbound_failed": "Message to the claimant failed",
  "audit.memory.applied": "Data from earlier cases used",
  ...
  "case.detail.pendientesTitulo": "Still needed to complete the case",
  "case.detail.technicalData": "Show technical data",
  "case.detail.verDetalleTecnico": "Show technical details",
  "case.detail.injuries": "Injuries",
  "case.detail.ramoSinCalibrar": "Uncalibrated claim type",
  "case.detail.ramoSinCalibrarAyuda": "This claim type has no specific rules yet: the agent does not know which data or documents to ask for. Review it more carefully.",
  "case.detail.resumen.reportaTipo": "{quien} reports a {tipo} claim",
  "case.detail.resumen.reporta": "{quien} reports a claim",
  "case.detail.resumen.asegurado": "The policyholder",
  "case.detail.resumen.fecha": " on {fecha}",
  "case.detail.resumen.lugar": " at {lugar}",
  "case.detail.resumen.sinHeridos": ", no injuries",
  "case.detail.resumen.conHeridos": ", with injuries",
  "case.detail.motivo.processingTimeout": "The analysis took too long",
  "case.detail.motivo.conflict": "A value does not match what we had",
  "case.detail.motivo.severidad": "Severity: {nivel}",
  "case.detail.motivo.lesiones": "Injuries or health data mentioned",
