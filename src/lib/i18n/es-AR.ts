...
export const esAR = {
  ...
  "tabs.filtrarPorEstado": "Filtrar por situación",
  ...
  "bandeja.paraResponder": "Para responder",
  ...
  "case.paraResponder.banner": "Llegó un mensaje después de que el agente terminó. Lo contesta una persona.",
  "case.paraResponder.marcar": "Marcar como respondido",
  "case.paraResponder.hecho": "Marcado como respondido.",
  "case.paraResponder.cambio": "El caso cambió mientras lo mirabas. Revisalo de nuevo.",
  ...
  "field.claim_type": "Tipo de siniestro",
  "field.hay_heridos": "Hay heridos",
  "field.hora_siniestro": "Hora del siniestro",
  "field.provincia_siniestro": "Provincia",
  "field.patente_vehiculo": "Patente del vehículo",

  // ── Doc status labels ──────────────────────────────────────────────────────
  "doc.status.pending": "Falta",
  ...
  "audit.case.status_changed": "Situación actualizada",
  "audit.case.marked_answered": "Marcado como respondido",
  "audit.claim.message_not_read": "Mensaje que el agente no leyó",
  ...
  "audit.email.received": "Llegó un mensaje",
  "audit.intake.agent_decision": "Decisión del agente",
  "audit.attachment.rejected": "Adjunto rechazado",
  "audit.claim.missing_info_requested": "Se le pidieron los datos que faltan",
  "audit.claim.confirmation_requested": "Se le pidió que confirme datos",
  "audit.claim.documents_received": "Llegó documentación",
  "audit.claim.documents_declined": "El asegurado avisó que no tiene un documento",
  "audit.claim.specialist_required": "Pasó a un especialista",
  "audit.claim.specialist_alerted": "Se avisó al especialista",
  "audit.claim.case_reopened": "Se reabrió por un mensaje nuevo",
  "audit.claim.closed_abandoned": "Se cerró porque el asegurado no contestó",
  "audit.claim.field_confirmed": "Se confirmó un dato",
  "audit.claim.field_rejected": "Se descartó un dato",
  "audit.case.assigned": "Se asignó a un analista",
  "audit.case.human_reply": "Le contestó una persona del equipo",
  "audit.case.re_analyze_triggered": "Se volvió a analizar",
  "audit.agent.deliberated": "El agente decidió el próximo paso",
  "audit.agent.note": "El agente dejó una nota",
  "audit.agent.deliberation_failed": "El agente no pudo decidir y siguió la regla fija",
  "audit.attachment.rehosted": "Se guardó un adjunto",
  "audit.email.outbound_sent": "Se le escribió al asegurado",
  "audit.email.outbound_failed": "No se pudo mandar el mensaje al asegurado",
  "audit.memory.applied": "Se usaron datos de casos anteriores",
  ...
  "case.detail.status": "Situación",
  "case.detail.statusUpdated": "Situación actualizada.",
  ...
  "case.detail.pendientesTitulo": "Falta para completar el caso",
  "case.detail.technicalData": "Ver datos técnicos",
  "case.detail.verDetalleTecnico": "Ver detalle técnico",
  "case.detail.injuries": "Lesiones",
  "case.detail.ramoSinCalibrar": "Ramo sin calibrar",
  "case.detail.ramoSinCalibrarAyuda": "Este tipo de siniestro todavía no tiene reglas específicas: el agente no sabe qué datos ni qué documentos pedir. Revisalo con más cuidado.",
  "case.detail.resumen.reportaTipo": "{quien} reporta un siniestro de {tipo}",
  "case.detail.resumen.reporta": "{quien} reporta un siniestro",
  "case.detail.resumen.asegurado": "El asegurado",
  "case.detail.resumen.fecha": " el {fecha}",
  "case.detail.resumen.lugar": " en {lugar}",
  "case.detail.resumen.sinHeridos": ", sin heridos",
  "case.detail.resumen.conHeridos": ", con heridos",
  "case.detail.motivo.processingTimeout": "El análisis tardó demasiado",
  "case.detail.motivo.conflict": "Un dato no coincide con lo que teníamos",
  "case.detail.motivo.severidad": "Severidad: {nivel}",
  "case.detail.motivo.lesiones": "Mencionó lesiones o datos de salud",
  ...
  "aiProvider.modelo": "Modelo de Gemini",
  ...
  "metricas.porEstado": "Siniestros por situación",
  ...
  "consola.pestanas": "Secciones de la consola del agente",
  ...
  "ft.errorCarga": "No se pudo cargar fine-tuning.",
  "ft.errorCrear": "No se pudo crear el trabajo.",
  ...
  "ft.vertex.cancelar": "Cancelar",
  "ft.vertex.cargando": "Cargando Vertex AI…",
  "ft.vertex.confirmar": "Confirmar",
  "ft.vertex.confirmarCosto": "Esto inicia un trabajo de fine-tuning en Google Cloud, con un costo estimado de",
  "ft.vertex.creaBorrador": "Creá un borrador para empezar.",
  "ft.vertex.crearBorrador": "Crear borrador",
  "ft.vertex.deshabilitado": "Vertex AI no está habilitado. Configurá las variables de entorno en el servidor para activarlo.",
  "ft.vertex.errorActivar": "No se pudo activar el modelo.",
  "ft.vertex.errorBorrador": "No se pudo crear el borrador.",
  "ft.vertex.errorIniciar": "No se pudo iniciar el trabajo.",
  "ft.vertex.errorSincronizar": "No se pudo sincronizar.",
  "ft.vertex.est": "est.",
  "ft.vertex.gastoTotal": "Gasto estimado total",
  "ft.vertex.habilitaPrimero": "Habilitá Vertex AI primero.",
  "ft.vertex.minEjemplos": "Mín. ejemplos:",
  "ft.vertex.modeloBase": "Modelo base:",
  "ft.vertex.precio": "y configuración de GCP. Precio estimado: US$ 0,008 cada 1.000 tokens de entrenamiento.",
  "ft.vertex.proyecto": "Proyecto:",
  "ft.vertex.region": "Región:",
  "ft.vertex.requiere": "Entrenamiento real por Google Cloud. Requiere",
  "ft.vertex.sinTrabajos": "No hay trabajos de Vertex AI.",
